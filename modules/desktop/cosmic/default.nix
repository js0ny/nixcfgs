{
  ...
  flake.homeModules.cosmic =
    ...
    in
    {
      ...
      xdg.configFile = {
        "cosmic/com.system76.CosmicTk/v1/icon_theme".text = rsStr config.nixdots.style.icon.dark;
        "cosmic/com.system76.CosmicTk/v1/interface_font".text =
          rsStr (builtins.head config.nixdots.style.fonts.sansSerif).name;
        "cosmic/com.system76.CosmicTk/v1/monospace_font".text =
          rsStr (builtins.head config.nixdots.style.fonts.editorMono).name;
