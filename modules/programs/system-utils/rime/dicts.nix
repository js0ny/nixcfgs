{ pkgs, ... }:
let
  rime-wanxiang = pkgs.js0ny.rime-wanxiang-zrm.raw;
  rime-cantonese = pkgs.js0ny.rime-cantonese.raw;
  rime-dieghv = pkgs.js0ny.rime-dieghv.raw;
  rime-latex = pkgs.js0ny.rime-latex.raw;
