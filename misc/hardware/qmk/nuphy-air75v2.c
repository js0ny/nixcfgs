/**
 * QMK Firmware:
 * Upstream: https://github.com/nuphy-src/qmk_firmware
 * dir:
 * qmk_firmware/keyboards/nuphy/air75_v2/ansi/keymaps/custom/keymap.c
 */
...
#define __SPCL 5
#define MT_CTSC MT(MOD_LCTL, KC_ESC) // Ctrl | Esc dual function
#define L_SPCL MO(__SPCL)            // Space layer
...
[0] = LAYOUT_ansi_84(
	...
	MT_CTSC,	KC_A,   	KC_S,   	KC_D,  		KC_F,   	KC_G,   	KC_H,   	KC_J,   	KC_K,   	KC_L,  		KC_SCLN,	KC_QUOT, 	 						KC_ENT,		KC_HOME,
